...
mini::DiffuseIrradianceRenderPass::~DiffuseIrradianceRenderPass()
{

}

void mini::DiffuseIrradianceRenderPass::update()
{

}

void mini::DiffuseIrradianceRenderPass::draw(CommandBuffer& cmd, std::vector<VkDescriptorSet> descSet)
{
	VkDeviceSize offset{ 0 };
...
void mini::DiffuseIrradianceRenderPass::rebuild(VkExtent2D surfaceExtent, int subpassIndex)
{
	extent = surfaceExtent;
